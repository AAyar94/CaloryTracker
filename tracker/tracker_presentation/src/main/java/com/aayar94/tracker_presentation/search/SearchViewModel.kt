package com.aayar94.tracker_presentation.search
...
class SearchViewModel @Inject constructor(
    ...
    private fun executeSearch() {
        viewModelScope.launch {
            ...
            trackerUseCases.searchFoodUseCase(state.query).onSuccess { foods ->
                state = state.copy(
                ...
                _uiEvent.send(UiEvent.ShowSnackbar(UiText.StringResource(com.aayar94.core.R.string.error_something_went_wrong)))
            }
        }
    }
