...
fun GoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    text = stringResource(id = com.aayar94.core.R.string.lose),
                ...
                SelectableButton(
                    text = stringResource(id = com.aayar94.core.R.string.keep),
                ...
                Spacer(modifier = Modifier.width(spacing.spaceMedium))
                SelectableButton(
                    text = stringResource(id = com.aayar94.core.R.string.gain),
